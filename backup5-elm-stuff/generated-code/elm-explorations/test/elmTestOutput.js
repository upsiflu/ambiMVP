...
var author$project$Helpers$segment_at = function (predicate) {
	return A2(
		elm$core$Basics$composeR,
		A2(
			elm$core$List$foldl,
			F2(
				function (itm, segments) {
					var _n0 = _Utils_Tuple2(
						segments,
						predicate(itm));
					if (_n0.b) {
...
var author$project$Compositron$Structure$Branch$deserialize = function (to_node) {
	var strip_empty = function (lines) {
		strip_empty:
		while (true) {
			if (_Utils_eq(
				A2(
					elm$core$Maybe$andThen,
					elm_community$string_extra$String$Extra$nonBlank,
				...
				lines = $temp$lines;
				continue strip_empty;
			} else {
				return lines;
			}
		}
	};
	var children = function (lines) {
		return A2(
			author$project$Helpers$segment_at,
			A2(
				elm$core$Basics$composeR,
		...
		A2(
			...
			A2(
				...
				A2(
					elm$core$Basics$composeR,
					strip_empty,
					A2(elm$core$Basics$composeR, elm$core$List$reverse, unfold)))));
};
var author$project$Compositron$Structure$Branch$from_string = author$project$Compositron$Structure$Branch$deserialize(elm$core$Basics$identity);
...
var author$project$Compositron$Structure$Branch$accept = F2(
	function (next, _n0) {
		var primer = _n0.a;
		var template_branch = _n0.b;
		return A3(zwilias$elm_rosetree$Tree$mapAccumulate, next, primer, template_branch);
	});
var author$project$Compositron$Structure$Branch$create = zwilias$elm_rosetree$Tree$tree;
var zwilias$elm_rosetree$Tree$children = function (_n0) {
	var c = _n0.b;
	return c;
};
var author$project$Compositron$Structure$Branch$kids = zwilias$elm_rosetree$Tree$children;
var zwilias$elm_rosetree$Tree$Zipper$tree = function (_n0) {
	var focus = _n0.a.focus;
	return focus;
};
var author$project$Compositron$Structure$EagerZipperTree$branch = zwilias$elm_rosetree$Tree$Zipper$tree;
var author$project$Helpers$all3 = F2(
	function (_n0, a) {
		var f = _n0.a;
		var g = _n0.b;
		var h = _n0.c;
...
var zwilias$elm_rosetree$Tree$Zipper$siblingsAfterFocus = function (_n0) {
	var after = _n0.a.after;
	return after;
};
var zwilias$elm_rosetree$Tree$Zipper$siblingsBeforeFocus = function (_n0) {
	var before = _n0.a.before;
	return elm$core$List$reverse(before);
};
var author$project$Compositron$Structure$EagerZipperTree$group = A2(
	elm$core$Basics$composeR,
	author$project$Helpers$all3(
		_Utils_Tuple3(zwilias$elm_rosetree$Tree$Zipper$siblingsBeforeFocus, author$project$Compositron$Structure$EagerZipperTree$branch, zwilias$elm_rosetree$Tree$Zipper$siblingsAfterFocus)),
	function (_n0) {
		var b = _n0.a;
		var f = _n0.b;
		var a = _n0.c;
		return {after: a, before: b, focus: f};
	});
var zwilias$elm_rosetree$Tree$label = function (_n0) {
	var v = _n0.a;
	return v;
};
var author$project$Compositron$Structure$Branch$node = zwilias$elm_rosetree$Tree$label;
var author$project$Compositron$Structure$EagerZipperTree$node = A2(elm$core$Basics$composeR, author$project$Compositron$Structure$EagerZipperTree$branch, author$project$Compositron$Structure$Branch$node);
...
var zwilias$elm_rosetree$Tree$Zipper$firstChild = function (_n0) {
	var zipper = _n0.a;
	var _n1 = zwilias$elm_rosetree$Tree$children(zipper.focus);
	if (!_n1.b) {
		return elm$core$Maybe$Nothing;
	} else {
		var c = _n1.a;
...
var zwilias$elm_rosetree$Tree$Zipper$nextSibling = function (_n0) {
	var zipper = _n0.a;
	var _n1 = zipper.after;
	if (!_n1.b) {
		return elm$core$Maybe$Nothing;
	} else {
		var next = _n1.a;
...
var zwilias$elm_rosetree$Tree$Zipper$nextSiblingOfAncestor = function (zipper) {
	...
	while (true) {
		...
		if (_n0.$ === 'Nothing') {
			...
			var parent_ = _n0.a;
			var _n1 = zwilias$elm_rosetree$Tree$Zipper$nextSibling(parent_);
			if (_n1.$ === 'Nothing') {
...
var author$project$Compositron$Structure$EagerZipperTree$find = zwilias$elm_rosetree$Tree$Zipper$findFromRoot;
var author$project$Helpers$LZipper$to_list = function (lz) {
	return _Utils_ap(
		lz.before,
		_Utils_ap(
			_List_fromArray(
...
var author$project$Compositron$Structure$Group$to_list = author$project$Helpers$LZipper$to_list;
...
var author$project$Compositron$Structure$EagerZipperTree$set_group = F2(
	function (grp, structure) {
		var _n0 = zwilias$elm_rosetree$Tree$Zipper$parent(structure);
		if (_n0.$ === 'Nothing') {
			return zwilias$elm_rosetree$Tree$Zipper$fromTree(grp.focus);
		} else {
			var p = _n0.a;
			var pivot = author$project$Compositron$Structure$Branch$node(grp.focus);
			var new_parent = A2(
				author$project$Compositron$Structure$Branch$create,
				author$project$Compositron$Structure$EagerZipperTree$node(p),
				author$project$Compositron$Structure$Group$to_list(grp));
			return A2(
				elm$core$Maybe$withDefault,
				structure,
				A2(
					author$project$Compositron$Structure$EagerZipperTree$find,
					elm$core$Basics$eq(pivot),
					A2(zwilias$elm_rosetree$Tree$Zipper$replaceTree, new_parent, p)));
		}
	});
var author$project$Helpers$map_if = F2(
	function (predicate, fu) {
		return predicate ? fu : elm$core$Basics$identity;
	});
...
var author$project$Compositron$Structure$EagerZipperTree$accept_template = F4(
	function (next, match, template, _n0) {
		var primer0 = _n0.a;
		var structure = _n0.b;
		var not_root = !_Utils_eq(
			zwilias$elm_rosetree$Tree$Zipper$parent(structure),
			elm$core$Maybe$Nothing);
		var live_group = author$project$Compositron$Structure$EagerZipperTree$group(structure);
		var forward = F2(
			function (remainder, _n1) {
				forward:
				while (true) {
					var pre = _n1.a;
					var acc = _n1.b;
					if (!remainder.b.b) {
						var live = remainder.a;
						return _Utils_Tuple2(
							pre,
							_Utils_ap(acc, live));
					} else {
						if (!remainder.a.b) {
							...
							return A2(
								...
								A2(
									...
									A2(
										author$project$Compositron$Structure$Branch$accept,
										next,
										_Utils_Tuple2(pre, t))));
						} else {
							var _n4 = remainder.a;
							...
							var t = _n5.a;
							var emp = _n5.b;
							var _n6 = A2(match, l, t);
							switch (_n6.$) {
								case 'Keep':
									var $temp$remainder = _Utils_Tuple2(ive, emp),
									...
									continue forward;
								case 'Skip':
									var $temp$remainder = _Utils_Tuple2(
										ive,
										A2(elm$core$List$cons, t, emp)),
										$temp$_n1 = _Utils_Tuple2(
										pre,
										_Utils_ap(
											acc,
			...
			function (_n10, _n11) {
				...
				return A2(
					...
					A2(
						...
						_Utils_Tuple2(pre, acc)));
			});
		var _n7 = A3(
			author$project$Helpers$map_if,
			not_root,
			backward(
				_Utils_Tuple2(live_group.before, template.before)),
			_Utils_Tuple2(primer0, _List_Nil));
		var primer1 = _n7.a;
		var back_branches = _n7.b;
		var _n8 = A2(
			forward,
			_Utils_Tuple2(
				_List_Nil,
				author$project$Compositron$Structure$Branch$kids(template.focus)),
			_Utils_Tuple2(primer1, _List_Nil));
		var primer2 = _n8.a;
		var kids = _n8.b;
		var _n9 = A3(
			author$project$Helpers$map_if,
			not_root,
			forward(
				_Utils_Tuple2(live_group.after, template.after)),
			_Utils_Tuple2(primer2, _List_Nil));
		var ender = _n9.a;
		var forth_branches = _n9.b;
		return _Utils_Tuple2(
			ender,
			A2(
				author$project$Compositron$Structure$EagerZipperTree$set_group,
				{
					after: forth_branches,
					before: back_branches,
					focus: A2(
						author$project$Compositron$Structure$Branch$create,
						author$project$Compositron$Structure$EagerZipperTree$node(structure),
						kids)
				},
				structure));
	});
...
var author$project$Compositron$Structure$Branch$serialize = function (from_node) {
	var serialize_at = F2(
		function (depth, brn) {
			return A2(
				elm$core$String$join,
				'\n' + A2(elm$core$String$repeat, 1 + depth, '  '),
				A2(
					elm$core$List$cons,
					from_node(
						author$project$Compositron$Structure$Branch$node(brn)),
					A2(
						elm$core$List$map,
						serialize_at(depth + 1),
						author$project$Compositron$Structure$Branch$kids(brn))));
		});
	return serialize_at(0);
};
var author$project$Compositron$Structure$EagerZipperTree$serialize = function (from_node) {
	return A2(
		elm$core$Basics$composeR,
		zwilias$elm_rosetree$Tree$Zipper$root,
		A2(
			elm$core$Basics$composeR,
			author$project$Compositron$Structure$EagerZipperTree$branch,
			author$project$Compositron$Structure$Branch$serialize(from_node)));
};
var author$project$Compositron$Structure$EagerZipperTree$to_string = author$project$Compositron$Structure$EagerZipperTree$serialize(elm$core$Basics$identity);
var author$project$Helpers$LZipper$map = F2(
	function (fu, lza) {
		return {
			after: A2(elm$core$List$map, fu, lza.after),
			before: A2(elm$core$List$map, fu, lza.before),
			focus: fu(lza.focus)
		};
	});
var author$project$Compositron$Structure$Branch$is = F3(
	function (eq, ba, bt) {
		return A2(
			eq,
			author$project$Compositron$Structure$Branch$node(ba),
			author$project$Compositron$Structure$Branch$node(bt)) && A3(
			elm$core$List$foldl,
			elm$core$Basics$and,
			true,
			A3(
				elm$core$List$map2,
				author$project$Compositron$Structure$Branch$is(eq),
				author$project$Compositron$Structure$Branch$kids(ba),
				author$project$Compositron$Structure$Branch$kids(bt)));
	});
var author$project$Helpers$Insert = {$: 'Insert'};
var author$project$Helpers$Keep = {$: 'Keep'};
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template0$match = F2(
	function (lb, tb) {
		return A3(author$project$Compositron$Structure$Branch$is, elm$core$Basics$eq, lb, tb) ? author$project$Helpers$Keep : author$project$Helpers$Insert;
	});
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template0$next = F2(
	function (p, t) {
		return _Utils_Tuple2(p + 1, t + '!');
	});
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template0$go = function (tmp) {
	return A2(
		elm$core$Basics$composeR,
		A3(
			author$project$Compositron$Structure$EagerZipperTree$accept_template,
			author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template0$next,
			author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template0$match,
			A2(author$project$Helpers$LZipper$map, author$project$Compositron$Structure$Branch$from_string, tmp)),
		elm$core$Tuple$mapSecond(author$project$Compositron$Structure$EagerZipperTree$to_string));
};
var author$project$Helpers$perhaps = F2(
	function (fu, parameter) {
		return A2(
			elm$core$Maybe$withDefault,
			parameter,
			fu(parameter));
	});
var author$project$Compositron$Structure$EagerZipperTree$deserialize = F2(
	function (to_node, focus) {
		return A2(
			elm$core$Basics$composeR,
			author$project$Compositron$Structure$Branch$deserialize(to_node),
			A2(
				elm$core$Basics$composeR,
				zwilias$elm_rosetree$Tree$Zipper$fromTree,
				author$project$Helpers$perhaps(
					author$project$Compositron$Structure$EagerZipperTree$find(focus))));
	});
var author$project$Compositron$Structure$EagerZipperTree$from_string = A2(
	author$project$Compositron$Structure$EagerZipperTree$deserialize,
	elm$core$Basics$identity,
	elm$core$Basics$always(true));
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template0$liv3 = author$project$Compositron$Structure$EagerZipperTree$from_string('a\n  b');
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template0$tmp3 = {
	after: _List_fromArray(
		['>']),
	before: _List_fromArray(
		['<', 'c']),
	focus: 'focus\n  new'
};
...
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template0$spec0 = A2(
	...
	function (_n0) {
		return A2(
			...
			A2(
				author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template0$go,
				author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template0$tmp3,
				_Utils_Tuple2(0, author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template0$liv3)),
			_Utils_Tuple2(1, 'a\n  new!'));
	});
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template1$match = F2(
	function (lb, tb) {
		return A3(author$project$Compositron$Structure$Branch$is, elm$core$Basics$eq, lb, tb) ? author$project$Helpers$Keep : author$project$Helpers$Insert;
	});
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template1$next = F2(
	function (p, t) {
		return _Utils_Tuple2(p + 1, t + '!');
	});
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template1$go = function (tmp) {
	return A2(
		elm$core$Basics$composeR,
		A3(
			author$project$Compositron$Structure$EagerZipperTree$accept_template,
			author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template1$next,
			author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template1$match,
			A2(author$project$Helpers$LZipper$map, author$project$Compositron$Structure$Branch$from_string, tmp)),
		elm$core$Tuple$mapSecond(author$project$Compositron$Structure$EagerZipperTree$to_string));
};
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template1$liv2 = A2(
	author$project$Helpers$perhaps,
	author$project$Compositron$Structure$EagerZipperTree$find(
		elm$core$Basics$eq('*')),
	author$project$Compositron$Structure$EagerZipperTree$from_string('a\n  b\n    c\n    *'));
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template1$tmp2 = {
	after: _List_fromArray(
		['>']),
	before: _List_fromArray(
		['<', 'c']),
...
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template1$spec1 = A2(
	elm_explorations$test$Test$test,
	'#accept_template: \n\n    go tmp2 ( 0, liv2 )\n    --> ( 2, \"a\\n  b\\n    <!\\n    c\\n    *\\n    >!\" )',
	function (_n0) {
		return A2(
			elm_explorations$test$Expect$equal,
			A2(
				author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template1$go,
				author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template1$tmp2,
				_Utils_Tuple2(0, author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template1$liv2)),
			_Utils_Tuple2(2, 'a\n  b\n    <!\n    c\n    *\n    >!'));
	});
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template2$match = F2(
	function (lb, tb) {
		return A3(author$project$Compositron$Structure$Branch$is, elm$core$Basics$eq, lb, tb) ? author$project$Helpers$Keep : author$project$Helpers$Insert;
	});
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template2$next = F2(
	function (p, t) {
		return _Utils_Tuple2(p + 1, t + '!');
	});
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template2$go = function (tmp) {
	return A2(
		elm$core$Basics$composeR,
		A3(
			author$project$Compositron$Structure$EagerZipperTree$accept_template,
			author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template2$next,
			author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template2$match,
			A2(author$project$Helpers$LZipper$map, author$project$Compositron$Structure$Branch$from_string, tmp)),
		elm$core$Tuple$mapSecond(author$project$Compositron$Structure$EagerZipperTree$to_string));
};
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template2$liv1 = A2(
	author$project$Helpers$perhaps,
	author$project$Compositron$Structure$EagerZipperTree$find(
		elm$core$Basics$eq('c')),
	author$project$Compositron$Structure$EagerZipperTree$from_string('a\n  b\n    c\n'));
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template2$tmp1 = {
	after: _List_fromArray(
		['>']),
	before: _List_fromArray(
		['<']),
...
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template2$spec2 = A2(
	elm_explorations$test$Test$test,
	'#accept_template: \n\n    go tmp1 ( 0, liv1 )\n    --> ( 2, \"a\\n  b\\n    <!\\n    c\\n    >!\" )',
	function (_n0) {
		return A2(
			elm_explorations$test$Expect$equal,
			A2(
				author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template2$go,
				author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template2$tmp1,
				_Utils_Tuple2(0, author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template2$liv1)),
			_Utils_Tuple2(2, 'a\n  b\n    <!\n    c\n    >!'));
	});
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template3$match = F2(
	function (lb, tb) {
		return A3(author$project$Compositron$Structure$Branch$is, elm$core$Basics$eq, lb, tb) ? author$project$Helpers$Keep : author$project$Helpers$Insert;
	});
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template3$next = F2(
	function (p, t) {
		return _Utils_Tuple2(p + 1, t + '!');
	});
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template3$go = function (tmp) {
	return A2(
		elm$core$Basics$composeR,
		A3(
			author$project$Compositron$Structure$EagerZipperTree$accept_template,
			author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template3$next,
			author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template3$match,
			A2(author$project$Helpers$LZipper$map, author$project$Compositron$Structure$Branch$from_string, tmp)),
		elm$core$Tuple$mapSecond(author$project$Compositron$Structure$EagerZipperTree$to_string));
};
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template3$liv0 = A2(
	author$project$Helpers$perhaps,
	author$project$Compositron$Structure$EagerZipperTree$find(
		elm$core$Basics$eq('b')),
	author$project$Compositron$Structure$EagerZipperTree$from_string('a\n  b\n  c\n  d\n  e'));
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template3$tmp0 = {
	after: _List_fromArray(
		['c', 'd', 'X', 'Y']),
	before: _List_Nil,
	focus: 'b'
};
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template3$spec3 = A2(
	elm_explorations$test$Test$test,
	'#accept_template: \n\n    go tmp0 ( 0, liv0 )\n    --> ( 2, \"a\\n  b\\n  c\\n  d\\n  X!\\n  Y!\\n  e\" )',
	function (_n0) {
		return A2(
			elm_explorations$test$Expect$equal,
			A2(
				author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template3$go,
				author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template3$tmp0,
				_Utils_Tuple2(0, author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template3$liv0)),
			_Utils_Tuple2(2, 'a\n  b\n  c\n  d\n  X!\n  Y!\n  e'));
	});
var zwilias$elm_rosetree$Tree$singleton = function (v) {
	return A2(zwilias$elm_rosetree$Tree$Tree, v, _List_Nil);
};
var author$project$Compositron$Structure$Branch$singleton = zwilias$elm_rosetree$Tree$singleton;
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Branch0$spec0 = A2(
	elm_explorations$test$Test$test,
	'#branch: \n\n    from_string \"a\\n  b\\n  c\"\n        |> perhaps ( find ( (==) \"c\") )\n        |> branch\n    --> Branch.singleton \"c\"',
	function (_n0) {
		return A2(
			...
			author$project$Compositron$Structure$EagerZipperTree$branch(
				A2(
					...
					author$project$Compositron$Structure$EagerZipperTree$find(
						elm$core$Basics$eq('c')),
					author$project$Compositron$Structure$EagerZipperTree$from_string('a\n  b\n  c'))),
			author$project$Compositron$Structure$Branch$singleton('c'));
	});
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Find0$find_in_structure = function (fu) {
	return A2(
		elm$core$Maybe$map,
		author$project$Compositron$Structure$EagerZipperTree$node,
		A2(
			author$project$Compositron$Structure$EagerZipperTree$find,
			fu,
			author$project$Compositron$Structure$EagerZipperTree$from_string('a\n  b')));
};
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Find0$spec0 = A2(
	elm_explorations$test$Test$test,
	'#find: \n\n    (==) \"c\"    |> find_in_structure\n    --> Nothing',
	function (_n0) {
		return A2(
			elm_explorations$test$Expect$equal,
			author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Find0$find_in_structure(
				elm$core$Basics$eq('c')),
			elm$core$Maybe$Nothing);
	});
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Find1$find_in_structure = function (fu) {
	return A2(
		elm$core$Maybe$map,
		author$project$Compositron$Structure$EagerZipperTree$node,
		A2(
...
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Find1$spec1 = A2(
	elm_explorations$test$Test$test,
	'#find: \n\n    (\\_-> True) |> find_in_structure\n    --> Just \"a\"',
	function (_n0) {
		return A2(
			elm_explorations$test$Expect$equal,
			author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Find1$find_in_structure(
				function (_n1) {
					return true;
				}),
			elm$core$Maybe$Just('a'));
	});
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Find2$find_in_structure = function (fu) {
	return A2(
		elm$core$Maybe$map,
		author$project$Compositron$Structure$EagerZipperTree$node,
		A2(
...
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Find2$spec2 = A2(
	elm_explorations$test$Test$test,
	'#find: \n\n    (==) \"b\"    |> find_in_structure\n    --> Just \"b\"',
	function (_n0) {
		return A2(
			elm_explorations$test$Expect$equal,
			author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Find2$find_in_structure(
				elm$core$Basics$eq('b')),
			elm$core$Maybe$Just('b'));
	});
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Group0$spec0 = A2(
	elm_explorations$test$Test$test,
	...
	function (_n0) {
		return A2(
			elm_explorations$test$Expect$equal,
			A2(
				author$project$Helpers$LZipper$map,
				author$project$Compositron$Structure$Branch$node,
				author$project$Compositron$Structure$EagerZipperTree$group(
					A2(
						author$project$Helpers$perhaps,
						author$project$Compositron$Structure$EagerZipperTree$find(
...
var author$project$Compositron$Structure$EagerZipperTree$singleton = A2(elm$core$Basics$composeR, author$project$Compositron$Structure$Branch$singleton, zwilias$elm_rosetree$Tree$Zipper$fromTree);
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Group1$spec1 = A2(
	elm_explorations$test$Test$test,
	'#group: \n\n    singleton \"a\" \n        |> group\n        |> LZipper.map Branch.node \n    --> { before = []\n    --> , focus  = \"a\"\n    --> , after  = [] \n    --> }',
	function (_n0) {
		return A2(
			...
			A2(
				...
				author$project$Compositron$Structure$Branch$node,
				author$project$Compositron$Structure$EagerZipperTree$group(
					author$project$Compositron$Structure$EagerZipperTree$singleton('a'))),
			{after: _List_Nil, before: _List_Nil, focus: 'a'});
	});
...
var author$project$Compositron$Structure$EagerZipperTree$mark = zwilias$elm_rosetree$Tree$Zipper$mapLabel;
var elm$core$String$toUpper = _String_toUpper;
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Mark0$spec0 = A2(
	elm_explorations$test$Test$test,
	...
	function (_n0) {
		return A2(
			...
			A3(
				elm$core$Basics$composeR,
				author$project$Compositron$Structure$EagerZipperTree$singleton,
				A2(
					elm$core$Basics$composeR,
					author$project$Compositron$Structure$EagerZipperTree$mark(elm$core$String$toUpper),
					author$project$Compositron$Structure$EagerZipperTree$node),
				'a'),
			'A');
	});
var author$project$Compositron$Structure$EagerZipperTree$template_group = function (struct) {
	return (_Utils_eq(
		zwilias$elm_rosetree$Tree$Zipper$parent(struct),
		elm$core$Maybe$Just(
			zwilias$elm_rosetree$Tree$Zipper$root(struct))) || _Utils_eq(
		zwilias$elm_rosetree$Tree$Zipper$parent(struct),
		elm$core$Maybe$Nothing)) ? {
		after: _List_Nil,
		before: _List_Nil,
		focus: author$project$Compositron$Structure$EagerZipperTree$branch(struct)
	} : author$project$Compositron$Structure$EagerZipperTree$group(struct);
};
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$ModuleDoc0$spec0 = A2(
	elm_explorations$test$Test$test,
	...
	function (_n0) {
		return A2(
			...
			A2(
				author$project$Helpers$LZipper$map,
				author$project$Compositron$Structure$Branch$node,
				author$project$Compositron$Structure$EagerZipperTree$template_group(
					A2(
						author$project$Helpers$perhaps,
						author$project$Compositron$Structure$EagerZipperTree$find(
							elm$core$Basics$eq('d')),
...
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$ModuleDoc1$spec1 = A2(
	elm_explorations$test$Test$test,
	'Module VerifyExamples: \n\n    from_string \"a\\n  b\\n    c\\n  d\\n    e\" \n        |> perhaps ( find ( (==) \"d\" ) )\n        |> template_group\n        |> LZipper.map Branch.node \n    --> { before = []\n    --> , focus  = \"d\"\n    --> , after  = [] \n    --> }',
	function (_n0) {
		return A2(
				...
				author$project$Compositron$Structure$EagerZipperTree$template_group(
					A2(
						...
						author$project$Compositron$Structure$EagerZipperTree$find(
							elm$core$Basics$eq('d')),
						author$project$Compositron$Structure$EagerZipperTree$from_string('a\n  b\n    c\n  d\n    e')))),
			{after: _List_Nil, before: _List_Nil, focus: 'd'});
	});
var author$project$Compositron$Structure$EagerZipperTree$tree = A2(elm$core$Basics$composeR, zwilias$elm_rosetree$Tree$Zipper$root, author$project$Compositron$Structure$EagerZipperTree$branch);
var author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Tree0$spec0 = A2(
	elm_explorations$test$Test$test,
	'#tree: \n\n    from_string \"a\\n  b\\n  c\"\n        |> perhaps ( find ( (==) \"c\") )\n        |> tree\n        |> Branch.node\n    --> \"a\"',
	function (_n0) {
		return A2(
			elm_explorations$test$Expect$equal,
			author$project$Compositron$Structure$Branch$node(
				author$project$Compositron$Structure$EagerZipperTree$tree(
					A2(
						author$project$Helpers$perhaps,
						author$project$Compositron$Structure$EagerZipperTree$find(
							elm$core$Basics$eq('c')),
	...
	elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Find0$spec0])),
				A2(
				elm_explorations$test$Test$describe,
				'VerifyExamples.Compositron.Structure.EagerZipperTree.ModuleDoc0',
				_List_fromArray(
					[author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$ModuleDoc0$spec0])),
				A2(
				elm_explorations$test$Test$describe,
				'VerifyExamples.Compositron.Structure.EagerZipperTree.Accept_template2',
				_List_fromArray(
					[author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template2$spec2])),
				A2(
				elm_explorations$test$Test$describe,
				'VerifyExamples.Compositron.Structure.EagerZipperTree.Group0',
				_List_fromArray(
					[author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Group0$spec0])),
				A2(
				elm_explorations$test$Test$describe,
				'VerifyExamples.Compositron.Structure.EagerZipperTree.Tree0',
				_List_fromArray(
					[author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Tree0$spec0])),
				A2(
				elm_explorations$test$Test$describe,
				'VerifyExamples.Compositron.Structure.EagerZipperTree.Find2',
				_List_fromArray(
					[author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Find2$spec2])),
				A2(
				elm_explorations$test$Test$describe,
				'VerifyExamples.Compositron.Structure.EagerZipperTree.Accept_template0',
				_List_fromArray(
					[author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template0$spec0])),
				A2(
				elm_explorations$test$Test$describe,
				'VerifyExamples.Compositron.Structure.EagerZipperTree.Find1',
				_List_fromArray(
					[author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Find1$spec1])),
				A2(
				elm_explorations$test$Test$describe,
				'VerifyExamples.Compositron.Structure.EagerZipperTree.Mark0',
				_List_fromArray(
					[author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Mark0$spec0])),
				A2(
				elm_explorations$test$Test$describe,
				'VerifyExamples.Compositron.Structure.EagerZipperTree.Group1',
				_List_fromArray(
					[author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Group1$spec1])),
				A2(
				elm_explorations$test$Test$describe,
				'VerifyExamples.Compositron.Structure.EagerZipperTree.Accept_template3',
				_List_fromArray(
					[author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template3$spec3])),
				A2(
				elm_explorations$test$Test$describe,
				'VerifyExamples.Compositron.Structure.EagerZipperTree.ModuleDoc1',
				_List_fromArray(
					[author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$ModuleDoc1$spec1])),
				A2(
				elm_explorations$test$Test$describe,
				'VerifyExamples.Compositron.Structure.EagerZipperTree.Accept_template1',
				_List_fromArray(
					[author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Accept_template1$spec1])),
				A2(
				elm_explorations$test$Test$describe,
				'VerifyExamples.Compositron.Structure.EagerZipperTree.Branch0',
				_List_fromArray(
					[author$project$VerifyExamples$Compositron$Structure$EagerZipperTree$Branch0$spec0]))
			])));
_Platform_export({'Test':{'Generated':{'Main2595748175':{'init':author$project$Test$Generated$Main2595748175$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-23666.sock";
