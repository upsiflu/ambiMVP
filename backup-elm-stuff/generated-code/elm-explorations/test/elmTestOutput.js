...
var author$project$Tests$all = A2(
	...
	_List_fromArray(
		[
			...
			'Addition',
			function (_n0) {
				return A2(elm_explorations$test$Expect$equal, 10, 3 + 7);
			}),
			A2(
			elm_explorations$test$Test$test,
			'String.left',
			function (_n1) {
				return A2(
					...
					'a',
					A2(elm$core$String$left, 1, 'abcdefg'));
			})
		]));
...
var author$project$Test$Generated$Main3061856054$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/f/ambiMVP/tests/Tests.elm']),
		processes: 4,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 236663048610677
	},
...
_Platform_export({'Test':{'Generated':{'Main3061856054':{'init':author$project$Test$Generated$Main3061856054$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-9034.sock";
